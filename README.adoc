...
image:https://github.com/JunoPLupus/fp-aula-02-imutabilidade-java/actions/workflows/maven.yml/badge.svg[Build Status, link=https://github.com/JunoPLupus/fp-aula-02-imutabilidade-java/actions/workflows/maven.yml]
